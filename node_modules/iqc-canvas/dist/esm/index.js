import require$$0 from '@napi-rs/canvas';
import 'fs';
import require$$2 from 'emoji-db';
import require$$3 from '../../lib/emoji-image';
...
const EmojiDbLib = require$$2;
const emojiImageByBrand = require$$3;
...
function measureBubble(ctx, text, emojis, rbWidth, reply) {
	...
	if (reply) {
		...
		ctx.measureText(reply.text || '').width;
...
var generateIQC_1 = iqc.generateIQC = generateIQC;

export { iqc as default, generateIQC_1 as generateIQC };
